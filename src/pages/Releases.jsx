      ...
      <section className="page-hero releases-hero">
        <div className="shell page-hero-grid">
          <div className="page-hero-copy">
            ...
            <h1>Rabbit Core Testnet V2.2.1 is <em>ready to verify.</em></h1>
            <p>Official Windows and Linux packages built from the published V2.2.1 source commit, with archive and internal SHA-256 verification.</p>
          </div>
          <div className="release-check-card">
            <FileCheck2 size={28} />
            <span>PUBLIC TESTNET V2.2.1</span>
