...
export default function Developers() {
  ...
  return (
    <main>
      ...
      <section className="section shell" id="start"><SectionHeader eyebrow="DEVELOPER START" title="The shortest path from zero to Rabbit." text="Testnet is the default development environment before Mainnet opens." /><div className="developer-steps"><article><span>01</span><h3>Connect Testnet</h3><p>Use Chain ID 9280 and the official live Rabbit Testnet RPC.</p></article><article><span>02</span><h3>Fund a wallet</h3><p>The tRAB faucet is planned and has no official endpoint yet.</p></article><article><span>03</span><h3>Deploy & call</h3><p>Use EVM contracts and familiar JSON-RPC transaction workflows.</p></article><article><span>04</span><h3>Inspect</h3><p>Confirm transactions and contracts through the Rabbit explorer.</p></article></div></section>
