    ...
    <main>
      <section className="page-hero mainnet-hero">
        <div className="shell page-hero-grid">
          ...
          <div className="network-summary-card"><div className="network-summary-head"><div><img src="/rabbit-mark.png" alt="" /><span><b>RABBIT MAINNET</b><small>PRODUCTION NETWORK</small></span></div><em className="future">NOT LAUNCHED</em></div><div className="network-summary-grid"><div><span>CHAIN ID</span><strong>{n.chainId}</strong></div><div><span>HEX</span><strong>{n.chainIdHex}</strong></div><div><span>CONSENSUS</span><strong>LCQ</strong></div><div><span>EXECUTION</span><strong>EVM</strong></div><div><span>NATIVE ASSET</span><strong>RAB</strong></div><div><span>PHASE</span><strong>POST-TESTNET</strong></div></div></div>
        </div>
      </section>
