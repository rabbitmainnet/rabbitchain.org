    ...
    <main>
      ...
      <section className="security-callout">
        <div className="shell">
          ...
          <div>
            ...
            <p>All Rabbit Testnet miners and node operators must install Rabbit Core Testnet V2.2 before activation. This upgrade preserves the existing chain, wallet, keystore, balances, contracts, datadir and persistent WorkSeat. Do not delete your data or register again.</p>
          </div>
          <a className="button light" href="#downloads">Download V2.2</a>
        </div>
      </section>
      ...
      <section className="section shell" id="downloads">
        <SectionHeader
          ...
          title="Verified Rabbit Core Testnet V2.2 downloads."
