...
export default function Mining() {
  return (
    <main>
      ...
      <section className="mining-flow-section"><div className="shell"><SectionHeader eyebrow="MINING FLOW" title="Four steps from release to participation." /><div className="mining-steps"><article><span>01</span><Download size={21} /><h3>Download</h3><p>Use the official Rabbit release for your operating system.</p></article><article><span>02</span><FileCheck2 size={21} /><h3>Verify</h3><p>Compare the binary SHA-256 before executing it.</p></article><article><span>03</span><HardDrive size={21} /><h3>Windows start</h3><p>Extract the ZIP, open the folder and run <code>Start-Rabbit-Core.cmd</code>. Create the local password and back up the keystore shown by Rabbit Core.</p></article><article><span>04</span><Cpu size={21} /><h3>Linux start</h3><p>Extract the archive, run <code>./rabbit-core --check</code>, then <code>./start-rabbit-core.command</code>. Create the local password and back up the keystore.</p></article></div></div></section>
