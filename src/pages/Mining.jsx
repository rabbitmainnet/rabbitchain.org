    ...
    <main>
      ...
      <section className="security-callout">
        <div className="shell">
          ...
          <div>
            ...
            <p>All Rabbit Testnet miners and node operators must install Rabbit Core Testnet V2.2.2 before activation. V2.2.2 automatically applies the hard-fork configuration to the existing datadir while preserving the chain, wallet, keystore, balances, contracts and persistent WorkSeat. Close the previous application, extract V2.2.2 into a new folder and start it normally. Do not delete your data or register again.</p>
          </div>
          <a className="button light" href="#downloads">Download V2.2.2</a>
        </div>
      </section>
      ...
      <section className="section shell" id="downloads">
        <SectionHeader
          ...
          title="Verified Rabbit Core Testnet V2.2.2 downloads."
