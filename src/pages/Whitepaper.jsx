...
export default function Whitepaper() {
  return (
    <main>
      <section className="page-hero whitepaper-hero"><div className="shell page-hero-grid"><div className="page-hero-copy"><span className="hero-eyebrow"><i /> OFFICIAL PROTOCOL PAPER</span><h1>The protocol, <em>documented properly.</em></h1><p>The Rabbit Chain Whitepaper documents the protocol architecture, LCQ Consensus, mining, eligibility, network economics, security model and the Testnet-to-Mainnet path.</p><div className="hero-ctas"><a className="button primary" href="https://github.com/rabbitmainnet/rabbit-chain-whitepaper" target="_blank" rel="noreferrer">Read Whitepaper <ArrowUpRight size={14} /></a><Link className="button secondary" to="/docs">Explore Docs <ArrowRight size={14} /></Link></div></div><div className="whitepaper-card"><div><img src="/rabbit-mark.png" alt="" /><span>RABBIT CHAIN</span></div><strong>Technical Whitepaper v1.2</strong><p>Public Testnet V2 · Rabbit Core V2.2.2 hard fork</p><section><span>LCQ CONSENSUS</span><span>EVM EXECUTION</span><span>NETWORK ECONOMICS</span><span>SECURITY MODEL</span></section></div></div></section>
