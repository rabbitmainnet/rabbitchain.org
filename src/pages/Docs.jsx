...
const sections = [
  ...
  { id: 'testnet', title: 'Rabbit Testnet', icon: Network, body: [['Purpose', 'The first public network for miners, nodes, wallets, applications and infrastructure.'], ['Chain ID', '9280 (0x2440)'], ['Native asset', 'RAB. Testnet RUSD is planned as an additional testing asset.'], ['Status', 'Pre-launch until the official public services are activated.']] },
  ...
  { id: 'releases', title: 'Releases', icon: FileCheck2, body: [['Binaries', 'Windows, Linux and macOS release tracks are published only when public binaries are finalized.'], ['Verification', 'Release pages should include version, platform and SHA-256 hashes before users run binaries.']] },
    ...
    <main className="docs-page">
      <div className="shell docs-shell">
        ...
        <article className="docs-content">
          ...
          <div className="docs-warning"><FileCode2 size={20} /><div><b>Pre-launch rule</b><p>Reserved RPC, explorer, faucet and binary locations are not presented as live until their public release gates are complete.</p></div></div>
        </article>
      </div>
    </main>
  )
