...
const sections = [
  ...
  { id: 'releases', title: 'Releases', icon: FileCheck2, body: [['Required version', 'Rabbit Core Testnet V2.3.5 is the current public Testnet release. Liveness V4 is active from block 97,991. The block 77,000 Liveness V3 activation remains part of the preserved network history. Existing Testnet history, wallet data and persistent participation state are preserved during the in-place upgrade.'], ['Mining UX', 'Rabbit Core creates or reuses the local mining wallet automatically, connects to the Rabbit P2P network, synchronizes and handles LCQ admission without manual RPC, WebSocket, peer or wallet configuration.'], ['Verification', 'Only install verified Rabbit Core V2.3.5 packages published in the official Rabbit release center and confirm the archive SHA-256 before extraction.']] },
