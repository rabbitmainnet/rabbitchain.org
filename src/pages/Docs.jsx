...
const sections = [
  ...
  { id: 'releases', title: 'Releases', icon: FileCheck2, body: [['Binaries', 'Rabbit Core Testnet V2.2.1 is published for Windows AMD64 and Linux AMD64.'], ['Verification', 'Verify the official archive and internal SHA-256 manifests before running binaries.']] },
