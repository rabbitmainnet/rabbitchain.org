...
const sections = [
  ...
  { id: 'releases', title: 'Releases', icon: FileCheck2, body: [['Required version', 'Rabbit Core Testnet V2.2.5 is required for the Fairness/Liveness upgrade at block 73,000. Existing Testnet history, wallet data and persistent participation state are preserved during the in-place upgrade.'], ['Mining UX', 'Rabbit Core creates or reuses the local mining wallet automatically, connects to the Rabbit P2P network, synchronizes and handles LCQ admission without manual RPC, WebSocket, peer or wallet configuration.'], ['Verification', 'Only install the verified Windows or Linux V2.2.5 packages published in the official Rabbit release center.']] },
