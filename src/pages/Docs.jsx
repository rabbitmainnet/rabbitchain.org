...
const sections = [
  ...
  { id: 'releases', title: 'Releases', icon: FileCheck2, body: [['Required version', 'Rabbit Core Testnet V2.2.3 is required for the stabilization fork at block 50,500. Do not continue running V2.2.2 past the activation block.'], ['Mining UX', 'Rabbit Core creates or reuses the local mining wallet automatically, connects to the Rabbit P2P network, synchronizes and handles LCQ admission without manual RPC, WebSocket, peer or wallet configuration.'], ['Verification', 'Only install the verified Windows or Linux V2.2.3 packages published in the official Rabbit release center.']] },
