...
const META = {
  ...
  '/mining': ['Mining — Rabbit Chain', 'Download Rabbit Core V2.3.4 and mine Rabbit Testnet with automatic wallet, resilient P2P recovery, synchronization and LCQ participation.'],
  ...
  '/releases': ['Releases — Rabbit Chain', 'Official Rabbit Core V2.3.4 release and SHA-256 verification center for the current public Testnet packages.'],
  '/about': ['About Rabbit Chain', 'Rabbit Chain project principles, architecture and public launch model.'],
  '/whitepaper': ['Whitepaper — Rabbit Chain', 'Read Rabbit Chain Technical Whitepaper v1.5 covering LCQ Consensus, the block 77,000 Liveness V3 record, architecture, mining, economics, security and the current Rabbit Core V2.3.4 release.'],
