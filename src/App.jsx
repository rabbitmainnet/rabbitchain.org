...
const META = {
  ...
  '/rab': ['RAB — Rabbit Chain Native Asset', 'RAB is the native asset for Rabbit EVM gas and consensus economics.'],
  ...
  '/community': ['Community — Rabbit Chain', 'Official Rabbit Chain GitHub, X, Discord, Reddit and community resources.'],
