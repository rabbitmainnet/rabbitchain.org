...
const META = {
  ...
  '/whitepaper': ['Whitepaper — Rabbit Chain', 'Read Rabbit Chain Technical Whitepaper v1.5 covering LCQ Consensus, Rabbit Core V2.3.0 Liveness V3, block 77,000, architecture, mining, economics and security.'],
