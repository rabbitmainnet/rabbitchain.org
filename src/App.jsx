...
const META = {
  ...
  '/mining': ['Mining — Rabbit Chain', 'Download Rabbit Core V2.3.6 and mine Rabbit Testnet with automatic wallet, resilient P2P recovery, synchronization and LCQ participation.'],
  ...
  '/releases': ['Releases — Rabbit Chain', 'Official Rabbit Core V2.3.6 release and SHA-256 verification center for the current public Testnet packages.'],
  '/about': ['About Rabbit Chain', 'Rabbit Chain project principles, architecture and public launch model.'],
  '/whitepaper': ['Whitepaper — Rabbit Chain', 'Read Rabbit Chain Technical Whitepaper v1.5 covering LCQ Consensus, the historical block 77,000 Liveness V3 record, architecture, mining, economics, security and Rabbit Core V2.3.6 with Liveness V4 active from block 97,991.'],
