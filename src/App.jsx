...
const META = {
  ...
  '/mining': ['Mining — Rabbit Chain', 'Download Rabbit Core V2.3.5 and mine Rabbit Testnet with automatic wallet, resilient P2P recovery, synchronization and LCQ participation.'],
