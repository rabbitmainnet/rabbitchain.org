...
const META = {
  ...
  '/mining': ['Mining — Rabbit Chain', 'Download Rabbit Core V2.2.3 and mine Rabbit Testnet with automatic wallet, P2P bootstrap, synchronization and LCQ participation.'],
