    ...
    <footer className="site-footer">
      <div className="shell footer-grid">
        <div className="footer-brand">
          ...
          <div className="footer-social"><a href="https://x.com/rabbit_mainnet" target="_blank" rel="noreferrer">X / Twitter ↗</a><a href="https://discord.gg/TBWspuEZss" target="_blank" rel="noreferrer">Discord ↗</a><a href="https://github.com/rabbitmainnet" target="_blank" rel="noreferrer">GitHub ↗</a></div>
        </div>
